...
class DiscoverController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UISearchControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let vc = ResultsController(style: .grouped)
    ...
    @objc func fetchData() {
        ...
        NewsService.discover(cursor: 0) { [weak self] posts in
            self?.timeline = posts
        }
    }
    ...
    func checkIfScrolledToBottom(_ indexPath: IndexPath) {
        ...
        if indexPath.row == timeline.count-2 {
    ...
    func loadMorePosts() {
        ...
        NewsService.discover(cursor: timeline.count+1) { [weak self] posts in
...
extension DiscoverController: UICollectionViewDataSourcePrefetching {
    ...
    func collectionView(_ collectionView: UICollectionView, prefetchItemsAt indexPaths: [IndexPath]) {
        ...
        prefetcher.maxConcurrentDownloads = 10
